...
<body class="hold-transition login-page" style="background:#40a518;">
<%--<body class="hold-transition login-page" style="background-image: url('https://prayas.digitalbull.in/admin/upload/back.jpg')">--%>
    ...
    <form id="form1" runat="server">
        <div class="login-box">
            ...
            <center>
                <p style="font-family:Bahnschrift;">©2026 All right reserved by Digital Bull</p>
            </center>
        </div>
    </form>
