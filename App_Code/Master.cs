...
public class Master
{
    ...
    public SqlDataReader Status_Operation(string query)
    {
    ...
    public int Insert_Enquiry(string name,string email, string mobileno,  string message,string create_date,string create_time)
    {
        con.Close();
        con.Open();
        int RowsAffected = 0;
    ...
    public int Insert_Adission(string name, string classes, string mobileno, string message, string create_date, string create_time)
    {
        con.Close();
        con.Open();
        int RowsAffected = 0;
        try
        {
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            cmd.CommandText = "insert into admission(classes,name,mobileno,message,create_date,create_time) values (@classes,@name,@mobileno,@message,@create_date,@create_time)";
            cmd.CommandType = CommandType.Text;
